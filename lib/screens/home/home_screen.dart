    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "Expenses",
          style:
              TextStyle(color: Colors.black, fontSize: 20.sp, letterSpacing: 2),
        ),
      ),
      body: SafeArea(
        child: Padding(
            ...
            children: [
              Expanded(
                child: ListView.builder(
                  ...
                  itemCount: ExpenseData.expData.length,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                  "\$ ${ExpenseData.expData[index].amount}"),
                              Row(
                                children: [
                                  Icon(
                                    icons[ExpenseData
                                        .expData[index].category],
                                  ),
                                  const SizedBox(
                                    width: 6,
                                  ),
                                  Text(ExpenseData.expData[index].date
                                      .toString()
                                      .split(" ")[0])
                                ],
                              )
